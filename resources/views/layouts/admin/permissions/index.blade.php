            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    ...
                    <a href="{{ route('admin.permissions.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Új engedély') }}</span>
                    </a>
                    @endcan
                </div>
            </div>
                            ...
                            <tr data-entry-id="{{ $permission->id }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form onclick="return confirm('Biztos benne?')" class="d-inline" action="{{ route('admin.permissions.destroy', $permission->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
