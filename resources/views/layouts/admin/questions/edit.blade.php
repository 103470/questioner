        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('Kérdés szerkesztése')}}</h1>
                    <a href="{{ route('admin.questions.index') }}" class="btn btn-primary btn-sm shadow-sm">{{ __('Vissza') }}</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.questions.update', $question->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="question_text">{{ __('Kérdés') }}</label>
                    ...
                    <div class="form-group">
                        <label for="category">{{ __('Kategória') }}</label>
