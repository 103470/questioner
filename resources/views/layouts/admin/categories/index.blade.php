            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Új kategória') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr data-entry-id="{{ $category->id }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form onclick="return confirm('Biztos benne ?')" class="d-inline" action="{{ route('admin.categories.destroy', $category->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
